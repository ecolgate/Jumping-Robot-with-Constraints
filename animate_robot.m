...
for i = 1:size(state_list,2)
    ...
    if p.Results.show_constraint_forces
        ...
        foot.curr.force.left.x = -n_l(1)*F(1)*Fscale;
        foot.curr.force.left.z = -n_l(2)*F(1)*Fscale;
        foot.curr.force.right.x = -n_r(1)*F(2)*Fscale;
        foot.curr.force.right.z = -n_r(2)*F(2)*Fscale;
        % create vectors of x and z ends for both left and right
        xleft = [p_l(1),p_l(1)+foot.curr.force.left.x];
        zleft = [p_l(2),p_l(2)+foot.curr.force.left.z];
        xright = [p_r(1),p_r(1)+foot.curr.force.right.x];
        zright = [p_r(2),p_r(2)+foot.curr.force.right.z];
        % compute the reaction forces at the top and bottom of the spine
        spine.curr.force.top.x = F(3)*sin(theta_f + theta_s)*Fscale;
        spine.curr.force.top.z = F(3)*cos(theta_f + theta_s)*Fscale;
        spine.curr.force.bot.x = F(4)*sin(theta_f + theta_s)*Fscale;
        spine.curr.force.bot.z = F(4)*cos(theta_f + theta_s)*Fscale;
