...
function params = init_params
    ...
    params.model.dyn.body.Jm = 53.8e-6; % kg-m^2  moment of inertia of Maxon EC40 motor
    ...
    params.sim.motor.spine.peaktorque = 1.0; % Nm  assumes Maxon EC40 and 3.3x gear ratio
    params.sim.motor.body.peaktorque = 0.3; % Nm  assumes Maxon EC40
